...
export const MessageContentVisualsoTestChild: React.FC<Props> = ({groupMsg
...
export const MessageContentVisualsoTest = React.memo(MessageContentVisualsoTestChild);